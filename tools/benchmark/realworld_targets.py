...
_RAW_TARGETS: list[dict] = [
    ...
    {"name": "Parse Options Header", "package": "werkzeug",
     "module": "werkzeug.http", "function": "parse_options_header",
    ...
    {"name": "Parse Range Header", "package": "werkzeug",
     "module": "werkzeug.http", "function": "parse_range_header",
     "initial_args": {"value": "bytes=0-499, 500-999"},
     "category": "werkzeug",
     "description": "HTTP Range header — byte range parsing with validation"},
    {"name": "Parse Content Range Header", "package": "werkzeug",
     "module": "werkzeug.http", "function": "parse_content_range_header",
     "initial_args": {"value": "bytes 0-499/1234"},
     "category": "werkzeug",
     "description": "HTTP Content-Range — start/end/total extraction"},
    {"name": "Parse Dict Header", "package": "werkzeug",
     "module": "werkzeug.http", "function": "parse_dict_header",
     "initial_args": {"value": 'realm="test", nonce="abc123", qop="auth"'},
     "category": "werkzeug",
     "description": "HTTP dict header — quoted value parsing and unescaping"},
    {"name": "Parse List Header", "package": "werkzeug",
     "module": "werkzeug.http", "function": "parse_list_header",
     "initial_args": {"value": "text/html, application/json, text/plain"},
     "category": "werkzeug",
     "description": "HTTP list header — comma-separated items with quoting"},
    {"name": "Parse Cookie", "package": "werkzeug",
     "module": "werkzeug.http", "function": "parse_cookie",
    ...
    {"name": "Validate URL", "package": "validators",
     "module": "validators.url", "function": "url",
    ...
    {"name": "Validate Email", "package": "validators",
     "module": "validators.email", "function": "email",
     "initial_args": {"value": "user@example.com"},
     "category": "validators",
     "description": "Email address validation — local part, domain, quoted strings"},
    {"name": "Validate Hostname", "package": "validators",
     "module": "validators.hostname", "function": "hostname",
     "initial_args": {"value": "sub.example.com:8080"},
     "category": "validators",
     "description": "Hostname validation — labels, TLD, optional port"},
    {"name": "Validate Domain", "package": "validators",
     "module": "validators.domain", "function": "domain",
     "initial_args": {"value": "example.co.uk"},
     "category": "validators",
     "description": "Domain name validation — label length, TLD rules"},
    {"name": "Validate Russian INN", "package": "validators",
     "module": "validators.i18n.ru", "function": "ru_inn",
     "initial_args": {"value": "7707083893"},
     "category": "validators",
     "description": "Russian taxpayer ID — digit check with control sum"},
    {"name": "Validate French SSN", "package": "validators",
     "module": "validators.i18n.fr", "function": "fr_ssn",
     "initial_args": {"value": "2840845113794"},
     "category": "validators",
     "description": "French social security number — gender, year, dept, commune"},
    {"name": "Validate IPv4", "package": "validators",
     "module": "validators.ip_address", "function": "ipv4",
     "initial_args": {"value": "192.168.1.1"},
     "category": "validators",
     "description": "IPv4 address validation — octet ranges, CIDR notation"},
    {"name": "Validate Country Code", "package": "validators",
     "module": "validators.country", "function": "country_code",
    ...
    {"name": "Parse Phone Number", "package": "phonenumbers",
     "module": "phonenumbers.phonenumberutil", "function": "parse",
    ...
    {"name": "Is Possible Number String", "package": "phonenumbers",
     "module": "phonenumbers.phonenumberutil", "function": "is_possible_number_string",
    ...
    {"name": "URL Split", "package": "urllib",
     "module": "urllib.parse", "function": "urlsplit",
    ...
    {"name": "URL Quote", "package": "urllib",
     "module": "urllib.parse", "function": "quote",
     "initial_args": {"string": "hello world/foo&bar=baz"},
     "category": "urllib_parse",
     "description": "Percent-encode URL component — safe char handling"},
    {"name": "URL Encode", "package": "urllib",
     "module": "urllib.parse", "function": "urlencode",
    ...
    {"name": "Parse Query String", "package": "urllib",
     "module": "urllib.parse", "function": "parse_qs",
    ...
    {"name": "JSON Loads", "package": "simplejson",
     "module": "simplejson", "function": "loads",
    ...
    {"name": "Parse Date String", "package": "dateutil",
     "module": "dateutil.parser._parser", "function": "parse",
