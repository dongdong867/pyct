...
class EngineContext:
    ...
    Attributes:
        ...
        contracts: icontract preconditions / postconditions discovered on the
            target. Defaults to EMPTY_CONTRACTS when discovery yields nothing
            or when the optional `icontract` dependency is unavailable.
    """
